...
namespace ExperimentalApp.DataAccessLayer.DataDbContext;
...
public partial class DvdRentalContext : IdentityDbContext
{
    ...
    /// </summary>
    /// <param name="options">Parameters represent the setting of the database context</param>
    ...
    /// <summary>
    /// Gets or sets the user followers.
    /// </summary>
    public virtual DbSet<UserFollowers> UserFollowers { get; set; }

    /// <summary>
    /// Gets or sets the user tweets.
    /// </summary>
    public virtual DbSet<UserTweets> UserTweets { get; set; }
    ...
    /// <summary>
    /// Gets or sets the actor information.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the customer lists.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the film categories.
    /// </summary>
    public virtual DbSet<FilmCategory> FilmCategories { get; set; }

    /// <summary>
    /// Gets or sets the film lists.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the nicer but slower film lists.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the sales by film categories.
    /// </summary>
    public virtual DbSet<SalesByFilmCategory> SalesByFilmCategories { get; set; }

    /// <summary>
    /// Gets or sets the sales by stores.
    /// </summary>
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("Host=localhost;Database=dvdrental;Username=postgres;Password=zaihraiev");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserTweets>()
        ...
        const string ROLE_ID = "989e5d72-09f8-445d-9ac8-af80d6e3dbc7";
