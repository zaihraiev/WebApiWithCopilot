...
namespace ExperimentalApp.DataAccessLayer.Migrations
{
    ...
    [Migration("20231218132846_AddedFollowers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExperimentalApp.Core.Models.Tweet", b =>
                {
            ...
            modelBuilder.Entity("ExperimentalApp.Core.Models.UserFollowers", b =>
                {
            ...
            modelBuilder.Entity("ExperimentalApp.Core.Models.UserTweets", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4c94b8f4-78db-43de-a9da-e12c70671c77",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@gmail.com",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAEAACcQAAAAEMQQB3ozXjrEBXdx7ORf4sEERpseuGwYQ5PrZebpB0aom2PelajFEw8PKhXeEpW2dw==",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = "989e5d72-09f8-445d-9ac8-af80d6e3dbc7"
                        });
                });
            ...
            modelBuilder.Entity("ExperimentalApp.Core.Models.UserFollowers", b =>
                {
                    b.HasOne("ExperimentalApp.Core.Models.Identity.ApplicationUser", "Follower")
                        .WithMany("Followers")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExperimentalApp.Core.Models.Identity.ApplicationUser", "Following")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("ExperimentalApp.Core.Models.UserTweets", b =>
                {
                    b.HasOne("ExperimentalApp.Core.Models.Tweet", "Tweet")
                        .WithMany("UserTweets")
                        .HasForeignKey("TweetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExperimentalApp.Core.Models.Identity.ApplicationUser", "User")
                        .WithMany("UserTweets")
